...
const dest = new Date('jan 19, 2022 13:46:00').getTime();
...
const interval = setInterval(() => {
	...
	if (days == 0 && hrs == 0 && min == 0 && sec == 0) {
		console.log(colors.bgGreen.black('Counter 2'), colors.bgRed.black('Обратный отсчет завершен.'));
		clearInterval(interval);
		return;
	}

	console.log(colors.bgGreen.black('Counter 2'), colors.bgYellow.black('days: ', days + ' / hrs: ', hrs + ' / min: ', min + ' / sec: ', sec));
